...
<span>Brand Name : </span><input type="text" style="width:265px; height:30px;" name="contact" /><br>
<span>Contact No. : </span><input type="text" style="width:265px; height:30px;" name="cperson" /><br>
<span>Product Name : </span><textarea style="width:265px; height:80px;" name="note" /></textarea><br>
