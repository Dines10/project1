...
?>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>MSQUARE UPS-ERODE</center></font>
<div id="mainmain">
...
<a href="recharge.php"><i class="icon-group icon-2x"></i><br> Service payments</a> 
<a href="service.php"><i class="icon-group icon-2x"></i><br> Service Info</a>    
